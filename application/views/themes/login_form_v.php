...
<head>
	<meta charset="UTF-8">
	<title>Login-Koperasi Mitra Sejahtera</title>
...
<body>
	...
	<div class="form-box" id="login-box">
		<div class="header"><img height='80' align="center" >SISTEM KOPERASI MITRA SEJAHTERA</div>
		<form action="" method="post">
			...
			<div class="footer"> 
		<div align="center">&copy; Modified by. Koperasi Karyawan <?php echo date('Y'); ?> </div> 
			</div>
		</form>
	</div>
